    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Autopista Duarte Km 1 1/2", null, null, "Santiago", "DR", "51000", "STI", "Edificio Padre Arroyo" });

            migrationBuilder.InsertData(
                table: "Speakers",
                columns: new[] { "SpeakerId", "BlogUrl", "Company", "CompanyUrl", "FirstName", "GitHub", "LastName", "MiddleName", "Twitter" },
                values: new object[] { 1, "http://edgarsantiago.com", "Edgar Santiago Dev", "http://edgarsantiago.com", "Edgar", "edgarsantiag0", "Santiago", null, "edgarsantiag0" });

            migrationBuilder.InsertData(
                table: "Speakers",
                columns: new[] { "SpeakerId", "BlogUrl", "Company", "CompanyUrl", "FirstName", "GitHub", "LastName", "MiddleName", "Twitter" },
                values: new object[] { 2, "http://leogonell.com", "Ubicao SRL", "http://leogonell.com", "Leonardo", "leogonell", "Gonell", null, "leogonell" });

            migrationBuilder.InsertData(
                table: "Camps",
                columns: new[] { "CampId", "EventDate", "Length", "LocationId", "Moniker", "Name" },
                values: new object[] { 1, new DateTime(2018, 10, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, "BARCAMP2020", "BarCamp STI" });
